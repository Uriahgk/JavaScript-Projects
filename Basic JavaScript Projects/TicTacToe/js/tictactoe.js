...
function placeXOrO(squareNumber) {
    ...
    function computersTurn() {
        ...
        let pickASquare;
        //This condition allows our while loop to keep trying if a square is seleced already.
        while(!success) {
...
function disableClick() {
    ...
    setTimeout(function() { body.style.pointerEvents = "auto";b}, 1000);
}
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    x2 = coordX2,
    //This line indicates where the end of a y axis is.
    y2 = coordY2,
